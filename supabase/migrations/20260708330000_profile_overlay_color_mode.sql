-- Remove film-grain; cor padrão vs personalizada; constraint atualizada
ALTER TABLE public.profiles
  ADD COLUMN IF NOT EXISTS overlay_color_custom boolean NOT NULL DEFAULT false;

UPDATE public.profiles
SET overlay_type = NULL
WHERE overlay_type = 'film-grain';
...
COMMENT ON COLUMN public.profiles.overlay_color_custom IS
  'false = cor padrão branca (#ffffff); true = usa overlay_color';
