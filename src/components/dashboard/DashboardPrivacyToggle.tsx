...
export function DashboardPrivacyToggle({
  ...
  return (
    <label
      className={cn(
        "flex items-start justify-between gap-4 rounded-xl border px-4 py-3 transition-all duration-200",
        "border-white/[0.06] bg-white/[0.03]",
        disabled ? "cursor-not-allowed opacity-75" : "cursor-pointer hover:border-white/10 hover:bg-white/[0.05]",
