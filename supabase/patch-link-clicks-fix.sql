-- Fix: cliques em links sociais não contavam na home
-- Rode no Supabase SQL Editor se os cliques não sobem.
...
-- Teste rápido (troque o username):
-- SELECT username, link_click_count FROM public.profiles WHERE username = 'macan';
