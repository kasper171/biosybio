-- Atraso (segundos) para o wallpaper aparecer após toque em "revelar"
ALTER TABLE public.profiles
  ADD COLUMN IF NOT EXISTS background_reveal_delay_sec numeric NOT NULL DEFAULT 0;

COMMENT ON COLUMN public.profiles.background_reveal_delay_sec IS
  'Segundos após revelar o perfil até o wallpaper ficar visível (0 = imediato). Usado com tap-to-reveal/música.';
