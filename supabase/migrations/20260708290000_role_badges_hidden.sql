-- Escolha de quais badges de cargo aparecem na página (role_ids ocultos).
ALTER TABLE public.profiles
  ADD COLUMN IF NOT EXISTS role_badges_hidden jsonb NOT NULL DEFAULT '[]'::jsonb;

COMMENT ON COLUMN public.profiles.role_badges_hidden IS
  'Array de role_id ocultos na página pública. Vazio = todas visíveis.';
