-- Profile labels (Etiquetas): predefined tags with per-label colors.
ALTER TABLE public.profiles
  ADD COLUMN IF NOT EXISTS profile_labels jsonb NOT NULL DEFAULT '{"enabled":[],"colors":{},"show_emoji":true}'::jsonb;

COMMENT ON COLUMN public.profiles.profile_labels IS
  'Profile labels: { enabled: string[], colors: Record<string,string>, show_emoji: boolean }';
