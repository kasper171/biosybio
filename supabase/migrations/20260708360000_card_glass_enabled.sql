-- Efeito Glass (glassmorphism) opcional no card de bio
ALTER TABLE public.profiles
  ADD COLUMN IF NOT EXISTS card_glass_enabled boolean NOT NULL DEFAULT false;

COMMENT ON COLUMN public.profiles.card_glass_enabled IS
  'Ativa glassmorphism profissional na superfície do card de bio';
