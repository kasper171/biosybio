-- Marca "by Byosy" — Premium pode ocultar (hide_byosy_branding = true)
ALTER TABLE public.profiles
  ADD COLUMN IF NOT EXISTS hide_byosy_branding boolean NOT NULL DEFAULT false;

COMMENT ON COLUMN public.profiles.hide_byosy_branding IS
  'Premium: oculta badge "by Byosy" no canto da página pública';
